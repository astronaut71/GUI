...
**
** Created: Mon Feb 24 16:29:57 2014
...
public:
    ...
    QCheckBox *checkbox_useEnvironment;
    QCheckBox *checkbox_remember_settings;
    QSpacerItem *horizontalSpacer;
    QPushButton *button_connect;
    QSpacerItem *verticalSpacer_3;
    QSpacerItem *horizontalSpacer1;
    QPushButton *button_controlMotor;
    QHBoxLayout *horizontalLayout;
    QLabel *labelSpeed;
    QDoubleSpinBox *doubleSpinBox_speed;
    QHBoxLayout *horizontalLayout1;
    QLabel *labelTurn;
    QDoubleSpinBox *doubleSpinBox_turn;
    ...
    void setupUi(QMainWindow *MainWindowDesign)
    {
        ...
        camera = new QLabel(tab);
        camera->setObjectName(QString::fromUtf8("camera"));
        camera->setGeometry(QRect(80, 130, 650, 500));
        ...
        dock_status->setMinimumSize(QSize(399, 635));
        ...
        checkbox_useEnvironment = new QCheckBox(groupBox);
        checkbox_useEnvironment->setObjectName(QString::fromUtf8("checkbox_useEnvironment"));
        checkbox_useEnvironment->setLayoutDirection(Qt::RightToLeft);
        checkbox_useEnvironment->setChecked(true);

        gridLayout->addWidget(checkbox_useEnvironment, 6, 0, 1, 2);
        ...
        horizontalSpacer1 = new QSpacerItem(170, 21, QSizePolicy::Expanding, QSizePolicy::Minimum);

        verticalLayout_3->addItem(horizontalSpacer1);

        button_controlMotor = new QPushButton(frame);
        button_controlMotor->setObjectName(QString::fromUtf8("button_controlMotor"));
        button_controlMotor->setEnabled(true);
        sizePolicy2.setHeightForWidth(button_controlMotor->sizePolicy().hasHeightForWidth());
        button_controlMotor->setSizePolicy(sizePolicy2);
        button_controlMotor->setCheckable(true);

        verticalLayout_3->addWidget(button_controlMotor);
        ...
        doubleSpinBox_speed = new QDoubleSpinBox(frame);
        doubleSpinBox_speed->setObjectName(QString::fromUtf8("doubleSpinBox_speed"));
        doubleSpinBox_speed->setMinimum(-64);
        doubleSpinBox_speed->setMaximum(64);
        ...
        horizontalLayout1->addWidget(labelTurn);

        doubleSpinBox_turn = new QDoubleSpinBox(frame);
        doubleSpinBox_turn->setObjectName(QString::fromUtf8("doubleSpinBox_turn"));
        doubleSpinBox_turn->setMinimum(-64);
        doubleSpinBox_turn->setMaximum(64);

        horizontalLayout1->addWidget(doubleSpinBox_turn);
        ...
        button_stop = new QPushButton(dockWidgetContents_2);
    ...
    void retranslateUi(QMainWindow *MainWindowDesign)
    {
        ...
        camera->setText(QApplication::translate("MainWindowDesign", "Start Analysis", 0, QApplication::UnicodeUTF8));
        tab_manager->setTabText(tab_manager->indexOf(tab), QApplication::translate("MainWindowDesign", "Camera", 0, QApplication::UnicodeUTF8));
        ...
        checkbox_useEnvironment->setText(QApplication::translate("MainWindowDesign", "Use environment variables", 0, QApplication::UnicodeUTF8));
...
#ifndef QT_NO_TOOLTIP
        button_controlMotor->setToolTip(QApplication::translate("MainWindowDesign", "Set the target to the current joint trajectory state.", 0, QApplication::UnicodeUTF8));
#endif // QT_NO_TOOLTIP
#ifndef QT_NO_STATUSTIP
        button_controlMotor->setStatusTip(QApplication::translate("MainWindowDesign", "Clear all waypoints and set the target to the current joint trajectory state.", 0, QApplication::UnicodeUTF8));
#endif // QT_NO_STATUSTIP
        button_controlMotor->setText(QApplication::translate("MainWindowDesign", "Control Motor", 0, QApplication::UnicodeUTF8));
        labelSpeed->setText(QApplication::translate("MainWindowDesign", "&Speed", 0, QApplication::UnicodeUTF8));
        labelTurn->setText(QApplication::translate("MainWindowDesign", "&Turn", 0, QApplication::UnicodeUTF8));
